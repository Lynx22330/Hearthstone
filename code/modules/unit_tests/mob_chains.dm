...
/datum/unit_test/mob_chains/Run()
	var/mob/living/centipede_head = allocate(/mob/living/simple_animal/noita_worm)
	...
	for (var/i in 1 to 2)
		var/mob/living/new_segment = allocate(/mob/living/simple_animal/noita_worm)
	...
	var/mob/living/victim = allocate(/mob/living/simple_animal/noita_worm)
