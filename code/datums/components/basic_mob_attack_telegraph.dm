...
/datum/component/basic_mob_attack_telegraph/Initialize(
	telegraph_icon = 'modular_hearthstone/icons/mob/telegraphing/telegraph.dmi',
...
/datum/component/basic_mob_attack_telegraph/proc/on_attack(mob/living/simple_animal/source, atom/target)
	SIGNAL_HANDLER
	...
	//	INVOKE_ASYNC(src, PROC_REF(delayed_attack), source, target)              FUCK IT ITS GONE OK?
	return COMPONENT_HOSTILE_NO_ATTACK

/// Perform an attack after a delay
/datum/component/basic_mob_attack_telegraph/proc/delayed_attack(mob/living/simple_animal/source, atom/target)
