...
/datum/component/leash/Initialize(
	...
	// AddComponent(/datum/component/connect_containers, owner, container_connections) // We are not connecting containers yet.
...
/datum/component/leash/proc/on_parent_pre_move(atom/movable/source, atom/new_location)
	...
	//if (ismob(source))
	//	source.balloon_alert(source, "too far!")  // Not porting ballon_alerts.
...
/datum/component/leash/proc/force_teleport_back(reason)
	...
	// if (ismob(movable_parent))
		// movable_parent.balloon_alert(movable_parent, "moved out of range!") // Do not have balloon alerts, no need for them.
